...
export function DashboardHome({ user, onNavigate }: Readonly<DashboardHomeProps>) {
  const recentBuilds = [
    {
      id: 1,
      character: "Hu Tao",
      buildName: "Vaporize DPS",
  ...
  const popularBuilds = [
    {
      ...
      buildName: "Hypercarry",
      author: "ElementalMaster",
      likes: 156,
    },
    {
      id: 2,
      character: "Kazuha",
      buildName: "EM Support",
      author: "WindBlade",
      likes: 142,
    },
    {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Ready to create some amazing character builds?
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your latest character build creations
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              variant="outline"
              className="w-full"
              onClick={() => onNavigate("popular-builds")}
            >
              Explore More
            </Button>
          </CardContent>
