...
export default function CharacterBuildForm() {
  ...
  const addArtifactSet = (artifactIndex: number) => {
    setFormData((prev) => ({
      ...
      artifacts: prev.artifacts.map((artifact, i) =>
        i === artifactIndex
          ? { ...artifact, artifactSets: [...artifact.artifactSets, { setId: "", piecesCount: 2 }] }
          : artifact,
      ),
    }))
  }
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Genshin Impact Character Build</CardTitle>
          <CardDescription>Create and customize your character build configuration</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TabsContent value="general" className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Select onValueChange={addSubStat} defaultValue="CRIT Rate%">
                      <SelectTrigger>
                          ...
                          <div className="grid gap-4 md:grid-cols-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <Select
                                ...
                                onValueChange={(value) =>
                                  updateWeapon(index, "weaponRefinement", value ? Number.parseInt(value) : null)
                                }
                                defaultValue="1"
                              >
                                <SelectTrigger>
                            ...
                            {artifact.artifactSets.map((set, setIndex) => (
                              <div key={setIndex} className="grid gap-2 md:grid-cols-3 p-3 border rounded">
                                <Select
                                  ...
                                  defaultValue="gladiators-finale"
                                >
                                  <SelectTrigger>
